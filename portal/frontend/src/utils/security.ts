...
const ALLOWED_RPC_TYPES = new Set([
  ...
  'WGCP_ACHIEVEMENT_INCREMENT',
  'WGCP_ACHIEVEMENT_ACK',
  'WGCP_ACHIEVEMENT_PROGRESS',
  'WGCP_ACHIEVEMENT_PROGRESS_ACK',
  'WGCP_LEADERBOARD_TOKEN',
  'WGCP_LEADERBOARD_TOKEN_ACK',
  'WGCP_LEADERBOARD_SUBMIT',
  'WGCP_LEADERBOARD_SUBMIT_ACK',
  'WGCP_LEADERBOARD_GET_SCORES',
  'WGCP_LEADERBOARD_GET_SCORES_ACK',
  'WGCP_LEADERBOARD_PERSONAL_BEST',
  'WGCP_LEADERBOARD_PERSONAL_BEST_ACK',
  'WGCP_PROGRESSION_ADD_XP',
  'WGCP_PROGRESSION_ADD_XP_ACK',
  'WGCP_PROGRESSION_GET',
  'WGCP_PROGRESSION_GET_ACK',
  'WGCP_SCORE_SUBMIT',
  'WGCP_SCORE_ACK',
  'WGCP_MIGRATE',
  'WGCP_MIGRATION_ACK',
  ...
  'WGCP_TOGGLE_MENU',
  'WGCP_CONFLICT_TRIGGER',
  'WGCP_CONFLICT_RESOLUTION',
  'WGCP_TELEMETRY_PERF'
]);
